...
async def run():
    ...
    async def fly_figure8(center, duration_s, amp_n, amp_e):
        ...
        while True:
            ...
            down = center.down_m
            await drone.offboard.set_position_ned(PositionNedYaw(north, east, down, yaw_after_takeoff))
            await asyncio.sleep(SETPOINT_DT)
    ...
    target_down = PositionNedYaw(target_takeoff.north_m, target_takeoff.east_m, -0.5, yaw_after_takeoff)
    print("Descending...")
